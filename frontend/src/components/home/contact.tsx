...
const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-[#DAD7CD]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#3A5A40]">vedtellawar@eventora.com</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#3A5A40] mb-1">Eventora</p>
                            ...
                            <div className="bg-white rounded-lg border border-[#A3B18A]/20 p-6">
